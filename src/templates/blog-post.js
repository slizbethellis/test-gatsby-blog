              ...
              {tags.map((tag, index) => (
                <li key={index}>
                  <Link
                    ...
                    className='border-2 border-lila-900 dark:border-fuzz-300 rounded-full text-phthalo-900 dark:text-phthalo-100 hover:no-underline hover:ring-2  hover:ring-lila-700 dark:hover:ring-fuzz-200 hover:border-lila-700 hover:dark:border-fuzz-200 text-semibold px-4 py-1'
                  >{tag}</Link>
                </li>
              ))}
            </ul>
