...
const Toggle = ({ theme, toggleTheme }) => {
  ...
  return (
    ...
    >
      ...
      <ListboxOptions as='ul' anchor="bottom end" className='bg-phthalo-50 dark:bg-phthalo-950 rounded-lg ring-1 ring-phthalo-900/20 shadow-sm shadow-phthalo-50/20 overflow-hidden w-32 md:w-36 text-sm text-phthalo-950 dark:text-phthalo-100 font-semibold dark:ring-0 dark:highlight-white/5 mt-1 py-1 z-[60]'>
        {modes.map((mode) => (
