      ...
      <nav className='mx-auto px-2 md:px-6 lg:px-8 relative flex h-16 items-center justify-between'>
        ...
        <div className='md:ml-6'>
          <div className='flex items-center space-x-3'>
            ...
            {componentMounted && (
              <div className='absolute inset-y-0 right-0 self-center md:static flex items-center md:border-l md:border-phthalo-200 md:dark:border-phthalo-700 md:ml-6 md:pl-5 md:space-x-3'>
                <div><Search /></div>
