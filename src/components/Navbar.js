            ...
            <div className='flex space-x-3'>
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className='text-phthalo-900 dark:text-phthalo-100 hover:underline hover:text-lila-800 dark:hover:text-fuzz-200 rounded-md px-3 py-2 text-base font-medium'
          ...
          <div className="space-y-1 px-2 pb-3 pt-2">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className='text-phthalo-900 dark:text-phthalo-100 hover:underline hover:text-lila-800 dark:hover:text-fuzz-200 block rounded-md px-3 py-2 text-base font-medium'
                activeClassName='bg-phthalo-100 dark:bg-phthalo-900 text-phthalo-950 dark:text-phthalo-50'
