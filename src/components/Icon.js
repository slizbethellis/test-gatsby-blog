...
export const Left = ({ ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M21 12H3m0 0l8.5-8.5M3 12l8.5 8.5" />
  </svg>
)

export const Right = ({ ...rest }) => (
  <svg
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
...
export const Search = ({ ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><circle cx="11" cy="11" r="8" /><path d="m21 21l-4.3-4.3" /></g>
  </svg>
)
